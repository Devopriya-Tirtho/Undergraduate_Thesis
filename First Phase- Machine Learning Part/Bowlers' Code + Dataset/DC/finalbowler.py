...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Sandeep Lamichhane.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Sandeep Lamichhane'],'Total Wicket':[Total_Wicket],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Sandeep Lamichhane_Performance.csv', index = False, header=True)    
