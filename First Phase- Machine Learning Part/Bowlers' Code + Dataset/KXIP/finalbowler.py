...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Varun Chakravarthy.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Varun Chakravarthy'],'Total Wicket':[Total_Wicket],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Varun Chakravarthy_Performance.csv', index = False, header=True)    
