...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Yarra Prithviraj.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Yarra Prithviraj'],'Total Wicket':[Total_Wicket],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Yarra Prithviraj_Performance.csv', index = False, header=True)    
