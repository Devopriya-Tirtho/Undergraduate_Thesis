...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Rasikh Salam.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Rasikh Salam'],'Total Wicket':[Total_Wicket],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Rasikh Salam_Performance.csv', index = False, header=True)    
