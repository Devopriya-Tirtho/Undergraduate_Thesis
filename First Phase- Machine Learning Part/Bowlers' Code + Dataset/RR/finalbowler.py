...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Varun Aaron.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Varun Aaron'],'Total Wicket':[Total_Wicket],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Varun Aaron_Performance.csv', index = False, header=True)    
