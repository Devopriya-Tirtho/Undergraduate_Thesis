...
dataset=pd.read_csv('34.Mayank Agarwal .csv')
###############################
'''Number of Rows'''
############################
b=dataset.shape
...
Performance_df = pd.DataFrame({'Player_Name':['Mayank Agarwal'],'Total Run':[Total_Run],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Mayank Agarwal_Result.csv', index = False, header=True)    
