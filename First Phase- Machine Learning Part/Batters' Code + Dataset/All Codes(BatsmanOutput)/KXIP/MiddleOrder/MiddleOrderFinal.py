...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Nicholas PooranWK-Batsman.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Nicholas Pooran'],'Total Run':[Total_Run],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Nicholas Pooran_Performance_Result.csv', index = False, header=True)    
