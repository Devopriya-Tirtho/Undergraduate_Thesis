...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Andre RussellBowling Allrounder.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Andre Russell'],'Total Run':[Total_Run],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Russell_Performance.csv', index = False, header=True)    
