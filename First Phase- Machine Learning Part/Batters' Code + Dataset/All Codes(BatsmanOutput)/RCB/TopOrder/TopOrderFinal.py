...
dataset=pd.read_csv('8.Parthiv Patel.csv')
###############################
'''Number of Rows'''
############################
b=dataset.shape
...
Performance_df = pd.DataFrame({'Player_Name':['Parthiv Patel'],'Total Run':[Total_Run],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Parthiv_Performance_result.csv', index = False, header=True)    
