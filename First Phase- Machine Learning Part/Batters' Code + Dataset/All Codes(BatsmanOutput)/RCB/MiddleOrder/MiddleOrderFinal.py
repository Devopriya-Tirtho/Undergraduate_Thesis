...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Shimron HetmyerBatsman.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Shimron Hetmyer'],'Total Run':[Total_Run],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Shimron Hetmyer_Performance_Result.csv', index = False, header=True)    
