...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Shivam DubeBowling Allrounder.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Shivam Dube'],'Total Run':[Total_Run],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Shivam Dube_Performance.csv', index = False, header=True)    
