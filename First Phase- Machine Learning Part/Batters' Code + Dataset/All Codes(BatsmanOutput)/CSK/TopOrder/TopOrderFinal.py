...
dataset=pd.read_csv('5.Shane Watson.csv')
###############################
'''Number of Rows'''
############################
b=dataset.shape
...
Ven_Pred=[2,8,2,6,2,2,4,5,9,1,2,2,2,3 ]

Opp_Pred=[12,1,4,8,6,2,4,2,9,12,9,8,1,6]
...
Performance_df = pd.DataFrame({'Player_Name':['Shane Watson'],'Total Run':[Total_Run],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Shane_Performance_result.csv', index = False, header=True)    
