...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Mitchell SantnerBowling Allrounder.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Mitchell Santner'],'Total Run':[Total_Run],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Mitchell Santner_performance_result.csv', index = False, header=True)    
