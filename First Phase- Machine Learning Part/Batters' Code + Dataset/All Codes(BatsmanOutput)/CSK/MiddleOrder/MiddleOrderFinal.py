...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Dhruv ShoreyBatsman.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Dhruv Shorey'],'Total Run':[Total_Run],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Dhruv_Performance_result.csv', index = False, header=True)    
