...
dataset=pd.read_csv('32.Sanju Samson .csv')
###############################
'''Number of Rows'''
############################
b=dataset.shape
...
Ven_Pred= [4,9,2,4,4,4,6,3,4,4,5,4,1,8]

Opp_Pred= [6,9,3,12,2,3,8,6,8,1,2,9,12,1]
...
Performance_df = pd.DataFrame({'Player_Name':['Sanju Samson'],'Total Run':[Total_Run],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Sanju_Performance_Result.csv', index = False, header=True)    
