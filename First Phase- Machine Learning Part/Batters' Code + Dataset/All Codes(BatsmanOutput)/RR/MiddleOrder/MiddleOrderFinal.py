...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Ashton TurnerBatting Allrounder.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Ashton Turner'],'Total Run':[Total_Run],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Ashton Turner_Performance_Result.csv', index = False, header=True)    
