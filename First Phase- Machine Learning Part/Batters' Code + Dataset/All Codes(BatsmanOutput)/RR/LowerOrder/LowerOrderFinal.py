...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Jofra ArcherBowling Allrounder.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Jofra Archer'],'Total Run':[Total_Run],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Jofra Archer_Performance_Result.csv', index = False, header=True)    
