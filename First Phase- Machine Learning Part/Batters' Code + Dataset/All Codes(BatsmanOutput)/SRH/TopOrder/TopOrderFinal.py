# -*- coding: utf-8 -*-
"""
Created on Thu Nov 26 13:17:53 2020
...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep 30 20:26:01 2020
...
''' Importing Dataset '''
##################################
##dataset=pd.read_csv('E:\Thesis\Final\Batsman\Top Order\werner1.csv',encoding='latin1')

dataset=pd.read_csv('Jonny Bairstow.csv')
###############################
'''Number of Rows'''
############################
b=dataset.shape
...
for value in df["VenAvg"]:
    if value>=0.0 and value<=12.99:
        AvgRatingVenue.append(1)
    elif value>=13.0 and value<=26.99:
        AvgRatingVenue.append(2)
    elif value>=27.0 and value<=62.99:
        AvgRatingVenue.append(3)
    elif value>=63.0 and value<=98.99:
...
for value in df["OppAvg"]:
    if value>=0.0 and value<=14.99:
        AvgRatingOpp.append(1)
    elif value>=15.00 and value<=30.99:
        AvgRatingOpp.append(2)
    elif value>=31.00 and value<=107.99:
        AvgRatingOpp.append(3)
    elif value>=108.00 and value<=183.99:
...
for value in df["CalSR"]:
    if value>=0.0 and value<=99.99:
        SrRating.append(1)
    elif value>=100.00 and value<=125.99:
       SrRating.append(2)
    elif value>=126.00 and value<=131.99:
        SrRating.append(3)
    elif value>=132.00 and value<=140.99:
        SrRating.append(4)
    elif value>=141.00 :
        SrRating.append(5)
...
for value in df["CalSR"]:
    ...
    elif value>=66.00 and value<=131.99:
       SrRatingOpp.append(2)
    elif value>=132 and value<=179.99:
        SrRatingOpp.append(3)
    elif value>=180.00 and value<=228.99:
...
for value in df["HighestScoreVenue"]:
    ...
    if value>=1.0 and value<=16:
        HighestScoreRating.append(1)
    elif value>=17 and value<=33:
        HighestScoreRating.append(2)
    elif value>=34 and value<=104:
        HighestScoreRating.append(3)
    elif value>=105 and value<=175:
...
if len(OppositionNumberList1)>0:
    ...
    for i in range(1,len(OppositionNumberList1)):
        df.at[OppositionNumberList1[i]-1,"OppositionValue"]=(4*(df.at[OppositionNumberList1[i-1]-1,'AvgRatingOpp'])+3*(df.at[OppositionNumberList1[i-1]-1,'MatchOpp'])+2*(df.at[OppositionNumberList1[i-1]-1,'SrRatingOpp'])+0.3*(df.at[OppositionNumberList1[i-1]-1,'HundredOppRating'])+0.5*(df.at[OppositionNumberList1[i-1]-1,'FiftyOppRating'])-0.2*df.at[OppositionNumberList1[i-1]-1,'ZeroOppRating'])
...
if len(OppositionNumberList2)>0:
    ...
    for i in range(1,len(OppositionNumberList2)):
        df.at[OppositionNumberList2[i]-1,"OppositionValue"]=(4*(df.at[OppositionNumberList2[i-1]-1,'AvgRatingOpp'])+3*(df.at[OppositionNumberList2[i-1]-1,'MatchOpp'])+2*(df.at[OppositionNumberList2[i-1]-1,'SrRatingOpp'])+0.3*(df.at[OppositionNumberList2[i-1]-1,'HundredOppRating'])+0.5*(df.at[OppositionNumberList2[i-1]-1,'FiftyOppRating'])-0.2*df.at[OppositionNumberList2[i-1]-1,'ZeroOppRating'])
...
if len(OppositionNumberList3)>0:
    ...
    for i in range(1,len(OppositionNumberList3)):
        df.at[OppositionNumberList3[i]-1,"OppositionValue"]=(4*(df.at[OppositionNumberList3[i-1]-1,'AvgRatingOpp'])+3*(df.at[OppositionNumberList3[i-1]-1,'MatchOpp'])+2*(df.at[OppositionNumberList3[i-1]-1,'SrRatingOpp'])+0.3*(df.at[OppositionNumberList3[i-1]-1,'HundredOppRating'])+0.5*(df.at[OppositionNumberList3[i-1]-1,'FiftyOppRating'])-0.2*df.at[OppositionNumberList3[i-1]-1,'ZeroOppRating'])
...
if len(OppositionNumberList4)>0:
    ...
    for i in range(1,len(OppositionNumberList4)):
        df.at[OppositionNumberList4[i]-1,"OppositionValue"]=(4*(df.at[OppositionNumberList4[i-1]-1,'AvgRatingOpp'])+3*(df.at[OppositionNumberList4[i-1]-1,'MatchOpp'])+2*(df.at[OppositionNumberList4[i-1]-1,'SrRatingOpp'])+0.3*(df.at[OppositionNumberList4[i-1]-1,'HundredOppRating'])+0.5*(df.at[OppositionNumberList4[i-1]-1,'FiftyOppRating'])-0.2*df.at[OppositionNumberList4[i-1]-1,'ZeroOppRating'])
...
if len(OppositionNumberList5)>0:
    ...
    for i in range(1,len(OppositionNumberList5)):
        df.at[OppositionNumberList5[i]-1,"OppositionValue"]=(4*(df.at[OppositionNumberList5[i-1]-1,'AvgRatingOpp'])+3*(df.at[OppositionNumberList5[i-1]-1,'MatchOpp'])+2*(df.at[OppositionNumberList5[i-1]-1,'SrRatingOpp'])+0.3*(df.at[OppositionNumberList5[i-1]-1,'HundredOppRating'])+0.5*(df.at[OppositionNumberList5[i-1]-1,'FiftyOppRating'])-0.2*df.at[OppositionNumberList5[i-1]-1,'ZeroOppRating'])
...
if len(OppositionNumberList6)>0:
    ...
    for i in range(1,len(OppositionNumberList6)):
        df.at[OppositionNumberList6[i]-1,"OppositionValue"]=(4*(df.at[OppositionNumberList6[i-1]-1,'AvgRatingOpp'])+3*(df.at[OppositionNumberList6[i-1]-1,'MatchOpp'])+2*(df.at[OppositionNumberList6[i-1]-1,'SrRatingOpp'])+0.3*(df.at[OppositionNumberList6[i-1]-1,'HundredOppRating'])+0.5*(df.at[OppositionNumberList6[i-1]-1,'FiftyOppRating'])-0.2*df.at[OppositionNumberList6[i-1]-1,'ZeroOppRating'])
...
if len(OppositionNumberList7)>0:
    ...
    for i in range(1,len(OppositionNumberList7)):
        df.at[OppositionNumberList7[i]-1,"OppositionValue"]=(4*(df.at[OppositionNumberList7[i-1]-1,'AvgRatingOpp'])+3*(df.at[OppositionNumberList7[i-1]-1,'MatchOpp'])+2*(df.at[OppositionNumberList7[i-1]-1,'SrRatingOpp'])+0.3*(df.at[OppositionNumberList7[i-1]-1,'HundredOppRating'])+0.5*(df.at[OppositionNumberList7[i-1]-1,'FiftyOppRating'])-0.2*df.at[OppositionNumberList7[i-1]-1,'ZeroOppRating'])
...
if len(OppositionNumberList8)>0:
    ...
    for i in range(1,len(OppositionNumberList8)):
        df.at[OppositionNumberList8[i]-1,"OppositionValue"]=(4*(df.at[OppositionNumberList8[i-1]-1,'AvgRatingOpp'])+3*(df.at[OppositionNumberList8[i-1]-1,'MatchOpp'])+2*(df.at[OppositionNumberList8[i-1]-1,'SrRatingOpp'])+0.3*(df.at[OppositionNumberList8[i-1]-1,'HundredOppRating'])+0.5*(df.at[OppositionNumberList8[i-1]-1,'FiftyOppRating'])-0.2*df.at[OppositionNumberList8[i-1]-1,'ZeroOppRating'])
...
if len(OppositionNumberList9)>0:
    ...
    for i in range(1,len(OppositionNumberList9)):
        df.at[OppositionNumberList9[i]-1,"OppositionValue"]=(4*(df.at[OppositionNumberList9[i-1]-1,'AvgRatingOpp'])+3*(df.at[OppositionNumberList9[i-1]-1,'MatchOpp'])+2*(df.at[OppositionNumberList9[i-1]-1,'SrRatingOpp'])+0.3*(df.at[OppositionNumberList9[i-1]-1,'HundredOppRating'])+0.5*(df.at[OppositionNumberList9[i-1]-1,'FiftyOppRating'])-0.2*df.at[OppositionNumberList9[i-1]-1,'ZeroOppRating'])
...
if len(OppositionNumberList10)>0:
    ...
    for i in range(1,len(OppositionNumberList10)):
        df.at[OppositionNumberList10[i]-1,"OppositionValue"]=(4*(df.at[OppositionNumberList10[i-1]-1,'AvgRatingOpp'])+3*(df.at[OppositionNumberList10[i-1]-1,'MatchOpp'])+2*(df.at[OppositionNumberList10[i-1]-1,'SrRatingOpp'])+0.3*(df.at[OppositionNumberList10[i-1]-1,'HundredOppRating'])+0.5*(df.at[OppositionNumberList10[i-1]-1,'FiftyOppRating'])-0.2*df.at[OppositionNumberList10[i-1]-1,'ZeroOppRating'])
...
if len(OppositionNumberList11)>0:
    ...
    for i in range(1,len(OppositionNumberList11)):
        df.at[OppositionNumberList11[i]-1,"OppositionValue"]=(4*(df.at[OppositionNumberList11[i-1]-1,'AvgRatingOpp'])+3*(df.at[OppositionNumberList11[i-1]-1,'MatchOpp'])+2*(df.at[OppositionNumberList11[i-1]-1,'SrRatingOpp'])+0.3*(df.at[OppositionNumberList11[i-1]-1,'HundredOppRating'])+0.5*(df.at[OppositionNumberList11[i-1]-1,'FiftyOppRating'])-0.2*df.at[OppositionNumberList11[i-1]-1,'ZeroOppRating'])
...
if len(OppositionNumberList12)>0:
    ...
    for i in range(1,len(OppositionNumberList12)):
        df.at[OppositionNumberList12[i]-1,"OppositionValue"]=(4*(df.at[OppositionNumberList12[i-1]-1,'AvgRatingOpp'])+3*(df.at[OppositionNumberList12[i-1]-1,'MatchOpp'])+2*(df.at[OppositionNumberList12[i-1]-1,'SrRatingOpp'])+0.3*(df.at[OppositionNumberList12[i-1]-1,'HundredOppRating'])+0.5*(df.at[OppositionNumberList12[i-1]-1,'FiftyOppRating'])-0.2*df.at[OppositionNumberList12[i-1]-1,'ZeroOppRating'])
...
if len(VenueNumberList1)>0:
    ...
    for i in range(1,len(VenueNumberList1)):
        df.at[VenueNumberList1[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList1[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList1[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList1[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList1[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList1[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList1[i-1]-1,'HighestScoreRating']))
        
if len(VenueNumberList2)>0:
    df.at[VenueNumberList2[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList2)):
        df.at[VenueNumberList2[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList2[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList2[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList2[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList2[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList2[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList2[i-1]-1,'HighestScoreRating']))
        
if len(VenueNumberList3)>0:
    df.at[VenueNumberList3[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList3)):
        df.at[VenueNumberList3[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList3[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList3[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList3[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList3[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList3[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList3[i-1]-1,'HighestScoreRating']))
        
if len(VenueNumberList4)>0:
    df.at[VenueNumberList4[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList4)):
        df.at[VenueNumberList4[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList4[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList4[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList4[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList4[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList4[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList4[i-1]-1,'HighestScoreRating']))
        
if len(VenueNumberList5)>0:
    df.at[VenueNumberList5[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList5)):
        df.at[VenueNumberList5[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList5[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList5[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList5[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList5[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList5[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList5[i-1]-1,'HighestScoreRating']))
        
if len(VenueNumberList6)>0:
    df.at[VenueNumberList6[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList6)):
        df.at[VenueNumberList6[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList6[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList6[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList6[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList6[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList6[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList6[i-1]-1,'HighestScoreRating']))
        
if len(VenueNumberList7)>0:
    df.at[VenueNumberList7[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList7)):
        df.at[VenueNumberList7[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList7[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList7[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList7[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList7[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList7[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList7[i-1]-1,'HighestScoreRating']))


if len(VenueNumberList8)>0:
    df.at[VenueNumberList8[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList8)):
        df.at[VenueNumberList8[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList8[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList8[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList8[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList8[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList8[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList8[i-1]-1,'HighestScoreRating']))
        
if len(VenueNumberList9)>0:
    df.at[VenueNumberList9[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList9)):
        df.at[VenueNumberList9[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList9[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList9[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList9[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList9[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList9[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList9[i-1]-1,'HighestScoreRating']))
        
if len(VenueNumberList10)>0:
    df.at[VenueNumberList10[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList10)):
        df.at[VenueNumberList10[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList10[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList10[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList10[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList10[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList10[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList10[i-1]-1,'HighestScoreRating']))
        
if len(VenueNumberList11)>0:
    df.at[VenueNumberList11[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList11)):
        df.at[VenueNumberList11[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList11[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList11[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList11[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList11[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList11[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList11[i-1]-1,'HighestScoreRating']))
        
if len(VenueNumberList12)>0:
    df.at[VenueNumberList12[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList12)):
        df.at[VenueNumberList12[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList12[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList12[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList12[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList12[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList12[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList12[i-1]-1,'HighestScoreRating']))
        
    
if len(VenueNumberList13)>0:
    df.at[VenueNumberList13[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList13)):
        df.at[VenueNumberList13[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList13[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList13[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList13[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList13[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList13[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList13[i-1]-1,'HighestScoreRating']))
            
if len(VenueNumberList14)>0:
    df.at[VenueNumberList14[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList14)):
        df.at[VenueNumberList14[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList14[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList14[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList14[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList14[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList14[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList14[i-1]-1,'HighestScoreRating']))
        
if len(VenueNumberList15)>0:
    df.at[VenueNumberList15[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList15)):
        df.at[VenueNumberList15[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList15[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList15[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList15[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList15[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList15[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList15[i-1]-1,'HighestScoreRating']))
        
if len(VenueNumberList16)>0:
    df.at[VenueNumberList16[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList16)):
        df.at[VenueNumberList16[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList16[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList16[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList16[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList16[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList16[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList16[i-1]-1,'HighestScoreRating']))
        
if len(VenueNumberList17)>0:
    df.at[VenueNumberList17[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList17)):
        df.at[VenueNumberList17[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList17[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList17[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList17[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList17[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList17[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList17[i-1]-1,'HighestScoreRating']))


if len(VenueNumberList18)>0:
    df.at[VenueNumberList18[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList18)):
        df.at[VenueNumberList18[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList18[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList18[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList18[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList18[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList18[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList18[i-1]-1,'HighestScoreRating']))


if len(VenueNumberList19)>0:
    df.at[VenueNumberList19[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList19)):
        df.at[VenueNumberList19[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList19[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList19[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList19[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList19[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList19[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList19[i-1]-1,'HighestScoreRating']))
    
    
if len(VenueNumberList20)>0:
    df.at[VenueNumberList20[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList20)):
        df.at[VenueNumberList20[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList20[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList20[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList20[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList20[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList20[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList20[i-1]-1,'HighestScoreRating']))
    
if len(VenueNumberList21)>0:
    df.at[VenueNumberList21[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList21)):
        df.at[VenueNumberList21[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList21[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList21[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList21[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList21[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList21[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList21[i-1]-1,'HighestScoreRating']))

if len(VenueNumberList22)>0:
    df.at[VenueNumberList22[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList22)):
        df.at[VenueNumberList22[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList22[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList22[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList22[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList22[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList22[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList22[i-1]-1,'HighestScoreRating']))

if len(VenueNumberList23)>0:
    df.at[VenueNumberList23[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList23)):
        df.at[VenueNumberList23[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList23[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList23[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList23[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList23[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList23[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList23[i-1]-1,'HighestScoreRating']))


if len(VenueNumberList24)>0:
    df.at[VenueNumberList24[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList24)):
        df.at[VenueNumberList24[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList24[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList24[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList24[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList24[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList24[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList24[i-1]-1,'HighestScoreRating']))

if len(VenueNumberList25)>0:
    df.at[VenueNumberList25[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList25)):
       df.at[VenueNumberList25[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList25[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList25[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList25[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList25[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList25[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList25[i-1]-1,'HighestScoreRating']))
       
if len(VenueNumberList26)>0:
    df.at[VenueNumberList26[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList26)):
       df.at[VenueNumberList26[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList26[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList26[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList26[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList26[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList26[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList26[i-1]-1,'HighestScoreRating']))
       
if len(VenueNumberList27)>0:
    df.at[VenueNumberList27[0]-1,"VenueValue"]=0
    for i in range(1,len(VenueNumberList27)):
        df.at[VenueNumberList27[i]-1,"VenueValue"]=(4*(df.at[VenueNumberList27[i-1]-1,'AvgRatingVenue'])+3*(df.at[VenueNumberList27[i-1]-1,'MatchVen'])+2*(df.at[VenueNumberList27[i-1]-1,'SrRating'])+0.3*(df.at[VenueNumberList27[i-1]-1,'HundredVenueRating'])+0.5*(df.at[VenueNumberList27[i-1]-1,'FiftyVenue'])+0.2*(df.at[VenueNumberList27[i-1]-1,'HighestScoreRating']))
...
##############################
####################################
############ Custom Accuracy of Logisic Regression with True Positive, True Negative, FP, FN ####################
...
#         elif(abs(row_element-col_element)==2):
#             true_positive.append((confusion_matrix_list[row_element][col_element])*50)
#             false_positive.append((confusion_matrix_list[row_element][col_element])*50)
...
Ven_Pred=[5,9,9,8,9,3,9,9,9,2,4,9,6,1]

Opp_Pred= [2,4,12,1,8,6,1,3,2,3,4,6,8,12]
...
Performance_df = pd.DataFrame({'Player_Name':['Jonny Bairstow'],'Total Run':[Total_Run],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Jonny_Bairstow_Performance_Result.csv', index = False, header=True)    
