...
dataset=pd.read_csv('26.Colin Munro - .csv')
###############################
'''Number of Rows'''
############################
b=dataset.shape
...
Ven_Pred= [6,8,8,3,8,1,5,9,8,8,4,8,2,8]

Opp_Pred= [8,3,2,6,9,12,2,9,8,6,4,12,3,4]
...
Performance_df = pd.DataFrame({'Player_Name':['Colin Munro'],'Total Run':[Total_Run],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Colin_Performance_Result.csv', index = False, header=True)    
