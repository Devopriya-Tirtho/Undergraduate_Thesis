...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Siddhesh LadBatsman.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Siddhesh Lad'],'Total Run':[Total_Run],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Siddhesh Lad_Performance_Result.csv', index = False, header=True)    
