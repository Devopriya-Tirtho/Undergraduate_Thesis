...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Ben Cutting.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Ben Cutting'],'Total Run':[Total_Run],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Ben Cutting_Performance.csv', index = False, header=True)    
