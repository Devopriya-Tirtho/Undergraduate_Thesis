...
dataset=pd.read_csv('22.Quinton de Kock .csv')
###############################
'''Number of Rows'''
############################
b=dataset.shape
...
Ven_Pred= [4,5,3,3,2,3,6,3,3,8,1,9,3,3]

Opp_Pred= [4,2,8,1,3,9,8,12,4,1,12,9,2,3]
...
Performance_df = pd.DataFrame({'Player_Name':['Quinton de Kock'],'Total Run':[Total_Run],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Quinton de Kock_Performace_Result.csv', index = False, header=True)    
