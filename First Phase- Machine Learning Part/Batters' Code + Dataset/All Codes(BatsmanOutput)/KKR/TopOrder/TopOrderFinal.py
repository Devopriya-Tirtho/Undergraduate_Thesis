...
dataset=pd.read_csv('12.Robin Uthappa.csv')
###############################
'''Number of Rows'''
############################
b=dataset.shape
...
Ven_Pred=[5,5,8,1,4,2,5,5,5,9,5,5,3,6]

Opp_Pred=[9,6,1,12,4,3,1,3,12,9,4,8,6,8]
...
Performance_df = pd.DataFrame({'Player_Name':['Robin Uthappa'],'Total Run':[Total_Run],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Robin_Performance_Result.csv', index = False, header=True)    
