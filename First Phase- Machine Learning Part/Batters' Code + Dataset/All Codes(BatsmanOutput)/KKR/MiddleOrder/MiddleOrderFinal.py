...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Nikhil NaikBatsman.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Nikhil Naik'],'Total Run':[Total_Run],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Nikhil Naik_Performance_Result.csv', index = False, header=True)    
