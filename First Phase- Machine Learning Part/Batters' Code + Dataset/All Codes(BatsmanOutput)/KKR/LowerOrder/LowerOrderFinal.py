...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Keemo PaulBowling Allrounder.csv')
...
for value in df["CalAvg"]:
    if value>=0.0 and value<=7.999999:
        AvgRating.append(1)
    elif value>=8.0 and value<=12.9999999:
       AvgRating.append(2)
    elif value>=13.0 and value<=18.999999:
        AvgRating.append(3)
    elif value>=19.0:
        AvgRating.append(4)
...
for value in df["VenAvg"]:
    if value>=0.0 and value<=3.99:
        AvgRatingVenue.append(1)
    elif value>=4.0 and value<=7.99:
        AvgRatingVenue.append(2)
    elif value>=8.0 and value<=11.99:
        AvgRatingVenue.append(3)
    elif value>=12.0 and value<=51.99:
...
for value in df["OppAvg"]:
    if value>=0.0 and value<=4.99:
        AvgRatingOpp.append(1)
    elif value>=5.00 and value<=9.99:
        AvgRatingOpp.append(2)
    elif value>=10.00 and value<=14.99:
        AvgRatingOpp.append(3)
    elif value>=15.00 and value<=40.99:
...
#BattingStrikeRate rating For Consistency,form, opposition and venue 75
SrRating=[]
for value in df["CalSR"]:
  
    if value>=0 and value<=104.99:
        SrRating.append(1)
    elif value>=105.00 and value<=134.99:
       SrRating.append(2)
    elif value>=135.00 and value<=152.99:
        SrRating.append(3)
    elif value>=153.00 and value<=170.99:
        SrRating.append(4)
    elif value>=170.00 :
        SrRating.append(5)
...
#BattingStrikeRate rating For opposition  12
SrRatingOpp=[]
for value in df["CalSR"]:
    if value>=0.0 and value<=45.99:
        SrRatingOpp.append(1)
    elif value>=46.00 and value<=79.99:
       SrRatingOpp.append(2)
    elif value>=80 and value<=113.99:
        SrRatingOpp.append(3)
    elif value>=114.00 and value<=224.99:
...
for value in df["HighestScoreVenue"]:
    ...
    elif value>=8 and value<=15.99:
        HighestScoreRating.append(2)
    elif value>=16 and value<=39.99:
        HighestScoreRating.append(3)
    elif value>=40 and value<=63.99:
...
Performance_df = pd.DataFrame({'Player_Name':['Keemo Paul'],'Total Run':[Total_Run],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Keemo Paul_Performance.csv', index = False, header=True)    
