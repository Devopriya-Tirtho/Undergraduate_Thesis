...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Sherfane Rutherford.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Sherfane Rutherford'],'Total Wicket':[Total_Wicket],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Sherfane Rutherford_Performance.csv', index = False, header=True)    
