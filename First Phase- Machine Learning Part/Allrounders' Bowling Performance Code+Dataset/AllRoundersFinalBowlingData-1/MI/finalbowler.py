...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Krunal Pandya.csv')
...
Ven_Pred=[6,1,3,6,9,6,6,6,8,4,2,5,6,6]


Opp_Pred=[1,12,6,3,9,6,4,12,1,4,3,2,9,2]
...
Performance_df = pd.DataFrame({'Player_Name':['Krunal Pandya'],'Total Wicket':[Total_Wicket],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Krunal Pandya_Performance.csv', index = False, header=True)    
