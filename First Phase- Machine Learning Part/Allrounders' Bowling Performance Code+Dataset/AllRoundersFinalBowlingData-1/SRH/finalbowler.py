...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Yusuf Pathan.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Yusuf Pathan'],'Total Wicket':[Total_Wicket],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Yusuf Pathan_Performance.csv', index = False, header=True)    
