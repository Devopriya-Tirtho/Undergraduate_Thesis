...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Sam Curran.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Sam Curran'],'Total Wicket':[Total_Wicket],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Sam Curran_Performance.csv', index = False, header=True)    
