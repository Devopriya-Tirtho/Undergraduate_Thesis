...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Washington Sundar.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Washington Sundar'],'Total Wicket':[Total_Wicket],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Washington Sundar_Performance.csv', index = False, header=True)    
