...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Stuart Binny.csv')
...
for value in df["SOver"]:
    if value>=1.0 and value<=9.99999999999999999999999999999999:
        OverForm.append(1)
    elif value>=10.0 and value<=24.9999999999999999999999999999:
        OverForm.append(2)
    elif value>=25.0 and value<=49.99999999999999999999999999999:
        OverForm.append(3)
    elif value>=50.0 and value<=99.9999999999999999999999999999999:
        OverForm.append(4)
    elif value>=100.0 :
        OverForm.append(5)
    else:
...
for value in df["OppOver"]:
    if value>=0 and value<=5.9999999999999999999999999:
        OverOpp.append(1)
    elif value>=6 and value<=10.99999999999999999999999:
        OverOpp.append(2)
    elif value>=11 and value<=35.9999999999999999999999:
        OverOpp.append(3)
    elif value>=36 and value<=60.999999999999999999999999:
        OverOpp.append(4)
    elif value>=61 :
        OverOpp.append(5)
df["OverOpp"] = OverOpp   
...
for value in df["VenueOver"]:
    if value>=0 and value<=5.9999999:
        OverVen.append(1)
    elif value>=6 and value<=10.999999:
        OverVen.append(2)
    elif value>=11 and value<=65.99999:
        OverVen.append(3)
    elif value>=66 and value<=131.999999:
        OverVen.append(4)
    elif value>=132 :
        OverVen.append(5)
df["OverVen"] = OverVen   
...
for value in df["OpAvg"]:
    if value>=0.0 and value<=13.9999999999999999999:
        AvgOpp.append(5)
    elif value>=14.0 and value<=25.99999999999999999999999999999999:
        AvgOpp.append(4)
    elif value>=26.00 and value<=69.99999999999999999999999999999999:
        AvgOpp.append(3)
    elif value>=70.00 and value<=113.99999999999999999999999999999999:
        AvgOpp.append(2)
    elif value>=114.00 :
        AvgOpp.append(1)
df["AvgOpp"] = AvgOpp   
...
for value in df["SRTotal"]:
    if value>=0.0 and value<=13.999999999999999999999999:
        SRCon.append(5)
    elif value>=14.0 and value<=19.99999999999999999999999999:
        SRCon.append(4)
    elif value>=20.00 and value<=27.9999999999999999999999999999:
        SRCon.append(3)
    elif value>=28.00 and value<=36.999999999999999999999999999999999:
        SRCon.append(2)
    elif value>=37.00 :
        SRCon.append(1)
df["SRCon"] = SRCon   
...
for value in df["EconomyRateTotal"]:
    ...
    if value>=0.00 and value<=4.9999999999999999999999999999999999:
        EconomyConRating.append(5)

    elif value>=5.00 and value<=6.999999999999999999999999999999999 :
        EconomyConRating.append(4)
    elif value>=7.00 and value<=8.9999999999999999999999999999999999999 :
        EconomyConRating.append(3)
    elif value>=9.00 and value<=10.999999999999999999999999999999999999999 :
...
for value in df["SEr"]:
    ...
    if value>=0.00 and value<=4.99:
        EconomyFormRating.append(5)

    elif value>=5.00 and value<=6.99 :
        EconomyFormRating.append(4)
    elif value>=7.00 and value<=8.99 :
        EconomyFormRating.append(3)
    elif value>=9.00 and value<=10.99 :
...
for value in df["OpEr"]:
    ...
    if value>=0.00 and value<=4.9999999999999999999999999999999999999:
        EconomyOppRating.append(5)

    elif value>=5.00 and value<=6.99999999999999999999999999999999999999 :
        EconomyOppRating.append(4)
    elif value>=7.00 and value<=8.999999999999999999999999999999999999 :
        EconomyOppRating.append(3)
    elif value>=9.00 and value<=10.99999999999999999999999999999999999 :
...
Performance_df = pd.DataFrame({'Player_Name':['Stuart Binny'],'Total Wicket':[Total_Wicket],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Stuart Binny_Performance.csv', index = False, header=True)    
