...
''' Importing Dataset '''
##################################
dataset=pd.read_csv('Shrikant Mundhe.csv')
...
Performance_df = pd.DataFrame({'Player_Name':['Shrikant Mundhe'],'Total Wicket':[Total_Wicket],'Cost':[17]})
#Performance_df = pd.DataFrame(Total_Run, columns= ['Total Run'])

Performance_df.to_csv (r'Shrikant Mundhe_Performance.csv', index = False, header=True)    
